...
class Processor : AbstractProcessor() {
    ...
    private fun process(roundEnv: RoundEnvironment) {
        ...
        val scopes = try {
            ...
            // TODO Handle ParsingErrors.
            processingEnv.messager.printMessage(Diagnostic.Kind.ERROR, "Failed")
            return
        }

        graph = Graph.create(scopes)

        if (graph.processingErrors.isNotEmpty()) {
